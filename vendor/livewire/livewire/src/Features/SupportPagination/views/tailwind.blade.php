                        ...
                        @foreach ($elements as $element)
                            ...
                            @if (is_string($element))
                                <span aria-disabled="true">
                                    <span class="relative inline-flex items-center px-3 py-1 -ml-px text-xs font-medium text-gray-700 bg-white border border-gray-300 cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300">{{ $element }}</span>
                                </span>
                            @endif
                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-3 py-1 -ml-px text-xs font-medium text-white border cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600" style="background-color: var(--color-accent);border: 1px solid var(--color-accent)">{{ $page }}</span>
                                            </span>
                                        @else
